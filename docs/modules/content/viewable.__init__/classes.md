Back to [Modules overview](https://github.com/pyrustic/viewable/blob/master/docs/modules/README.md)
...
## Classes
```python
class CustomView(viewable.__init__.Viewable):
    """
    ...
    # inherited from viewable.__init__.Viewable
    @property
    def body(self):
        """
...
```python
class MissingBodyError(viewable.__init__.Error):
    """
    Common base class for all non-exit exceptions.
    """

    # inherited from viewable.__init__.Error
    def __init__(self, *args, **kwargs):
        """
        Initialize self.  See help(type(self)) for accurate signature.
        """
